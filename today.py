...
if not ACCESS_TOKEN:
    raise RuntimeError('Missing ACCESS_TOKEN/GITHUB_TOKEN for GitHub API authentication')

HEADERS = {
    'Authorization': f'Bearer {ACCESS_TOKEN}',
    'Content-Type': 'application/json',
}
USER_NAME = os.environ['USER_NAME'] # 'shashwat39'
...
if __name__ == '__main__':
    """
    Shashwat (shashwat39), 2022-2024
    """
    print('Calculation times:')
    # define global variable for owner ID and calculate user's creation date
    # e.g {'id': 'MDQ6VXNlcjU3MzMxMTM0'} and 2019-11-03T21:15:07Z for username 'shashwat39'
    user_data, user_time = perf_counter(user_getter, USER_NAME)
    OWNER_ID, acc_date = user_data
    formatter('account data', user_time)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2003, 9, 3))
    ...
    if OWNER_ID == {'id': 'MDQ6VXNlcjU3MzMxMTM0'}: # only calculate for user shashwat39
